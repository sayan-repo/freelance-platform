...
import PaymentButton from '../../components/projects/PaymentButton';
            ...
            <div className="mt-8 bg-white shadow rounded-lg p-6">
                ...
                <ul>
                    {data.projects.length > 0 ? data.projects.map(p => (
                        <li key={p.id} className="flex justify-between items-center py-3 border-b last:border-b-0">
                            ...
                            {/* --- PAYMENT LOGIC --- */}
                            {p.status === 'completed' && p.hiredFreelancer?.walletAddress && (
                                <PaymentButton 
                                    freelancerAddress={p.hiredFreelancer.walletAddress}
                                    amount={p.budget}
                                    projectId={p.id}
                                />
                            )}
